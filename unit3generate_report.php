...
$result = $conn->query("SELECT studentmarks.studentname, studentmarks.id, studentmarks.pythonu3, html.htmlu3, css.cssu3, js.jsu3, mysql.sqlu3, c.cu3
FROM studentmarks
...
echo"<div class='d'>";
echo "<h2>UNIT 3 Student Report</h2>";
echo"</div>";
echo"<div class='div'>";
echo "<table border='1'>
        <tr>
