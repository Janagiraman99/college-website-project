...
$result = $conn->query("SELECT studentmarks.studentname, studentmarks.id, studentmarks.pythonu4, html.htmlu4, css.cssu4, js.jsu4, mysql.sqlu4, c.cu4
FROM studentmarks
...
echo"<div class='d'>";
echo "<h2>UNIT 4 Student Report</h2>";
echo"</div>";
echo"<div class='div'>";
echo "<table border='1'>
        <tr>
